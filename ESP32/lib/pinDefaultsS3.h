...
// OSR Stepper defaults: reuse main servo pins as step, SR6 auxiliaries as dir
#define STROKE_STEPPER_STEP_PIN_DEFAULT 1
#define STROKE_STEPPER_DIR_PIN_DEFAULT 4
#define ROLL_STEPPER_STEP_PIN_DEFAULT 2
#define ROLL_STEPPER_DIR_PIN_DEFAULT 5
#define PITCH_STEPPER_STEP_PIN_DEFAULT 3
#define PITCH_STEPPER_DIR_PIN_DEFAULT 6
#define AS5600_PWM_PIN_DEFAULT -1
